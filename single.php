...
<h3><?php the_time('F jS, Y') ?> at <?php the_time('h:i A') ?> | <?php comments_popup_link('Leave a Comment', '1 Comment', '% Comments');?> <?php edit_post_link('Edit', '| '); ?></h3>
